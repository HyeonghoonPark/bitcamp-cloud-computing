...
public class MemberService {
    ...
    public List<Member> list(int bno) {
        
        return memberDao.selectList(bno);
    }
...
//            throw new RuntimeException("일부로 예외 발생!");
    ...
    public void manageMentAdd(Member member) {
    	memberDao.manageMentAdd(member);
    }
